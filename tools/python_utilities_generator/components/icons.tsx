...
export const PythonIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M12.23 14.04l-3.36 3.36a1 1 0 01-1.42-1.42l3.36-3.36-2.12-2.12-4.24 4.24a1 1 0 01-1.42 0l-1.4-1.4a1 1 0 010-1.42L7.3 7.3a1.5 1.5 0 012.12 0L12 9.88l2.12-2.13a1 1 0 011.42 0l4.24 4.24-4.24 4.24-2.13-2.12 3.36 3.36a1 1 0 010 1.42l-1.4 1.4a1 1 0 01-1.42 0l-4.24-4.24-2.12 2.12zM12 1.5A3.5 3.5 0 008.5 5h-1A4.5 4.5 0 0112 0a4.5 4.5 0 014.5 4.5h-1A3.5 3.5 0 0012 1.5zm0 21a3.5 3.5 0 003.5-3.5h1A4.5 4.5 0 0112 24a4.5 4.5 0 01-4.5-4.5h1A3.5 3.5 0 0012 22.5z"></path>
  </svg>
);
