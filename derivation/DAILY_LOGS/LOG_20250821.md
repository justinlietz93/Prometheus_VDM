...
New Artifacts
- Doc: Prometheus_VDM/derivation/memory_steering/memory_steering_acceptance_verification.md
- Script: Prometheus_VDM/derivation/code/physics/memory_steering/memory_steering_acceptance.py
- Tests: Prometheus_VDM/derivation/code/tests/physics/test_memory_steering.py
- Output locations (when run):
  - JSON logs → Prometheus_VDM/derivation/code/outputs/logs/memory_steering/
  - Figures → Prometheus_VDM/derivation/code/outputs/figures/memory_steering/
