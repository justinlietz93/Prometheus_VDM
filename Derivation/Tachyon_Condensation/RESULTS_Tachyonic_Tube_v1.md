...
- OS: Linux; repo: Prometheus_VDM; branch: merge; commit: a91b8fa (git rev-parse HEAD).
...
- Figures:
  1) Overview — Derivation/code/outputs/figures/tachyonic_condensation/20251009_084702_tube_spectrum_overview__tube-spectrum-v1.png.
     Caption (numeric): coverage $\mathrm{cov}_{\rm phys}=1.000$ on $74/74$ admissible pairs; $\mathrm{cov}_{\rm raw}=0.548$ on $74/135$; max residual $|f|=0.709$; tag tube-spectrum-v1; commit a91b8fa; seed N/A.
  2) Possible/found heatmap — Derivation/code/outputs/figures/tachyonic_condensation/20251009_084703_tube_spectrum_heatmap__tube-spectrum-v1.png.
     Caption (numeric): no possible-but-missed bins; identical coverage metrics as above; tag tube-spectrum-v1; commit a91b8fa.
...
- Figure: Derivation/code/outputs/figures/tachyonic_condensation/20251009_062600_tube_energy_scan__tube-condensation-v1.png
  Caption (numeric): interior minimum at $R_\star\approx 1.35$ with positive curvature ($a=1.8109\dots>0$), finite_fraction $=1.0$; tag tube-condensation-v1; commit a91b8fa.
...
- Findings: $\mathrm{cov}_{\rm phys}=1.0$ (PASS); interior minimum with $a>0$ and finite_fraction $=1.0$ (PASS). Artifacts are standards-compliant and reproducible from commit a91b8fa.
