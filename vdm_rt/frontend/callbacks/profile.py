...
from vdm_rt.frontend.utilities.fs_utils import read_json_file, write_json_file
from vdm_rt.frontend.utilities.profiles import (
...
def register_profile_callbacks(app, profiles_dir: str, default_profile: Dict[str, Any]):
    ...
    IDs preserved to match existing layout (vdm_live).
    """
