...
from vdm_rt.frontend.components.widgets.file_picker import file_picker_overlay

from vdm_rt.frontend.components.workspace import workspace_card
from vdm_rt.frontend.components.runtime_controls import runtime_controls_card
from vdm_rt.frontend.components.feed import feed_card
from vdm_rt.frontend.components.config.run_config import run_config_card
from vdm_rt.frontend.components.charts import charts_card
from vdm_rt.frontend.components.chat import chat_card
from vdm_rt.frontend.components.perf import perf_card
...
def build_layout(
    ...
    IDs preserved to match existing callbacks in vdm_live.
    """
