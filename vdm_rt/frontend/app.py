...
from vdm_rt.frontend.utilities.fs_utils import list_runs, _list_files
from vdm_rt.frontend.services.process_manager import ProcessManager
from vdm_rt.frontend.utilities.profiles import get_default_profile
from vdm_rt.frontend.styles import get_global_css

from vdm_rt.frontend.components.layout import build_layout

from vdm_rt.frontend.callbacks.workspace import register_workspace_callbacks
from vdm_rt.frontend.callbacks.charts import register_chart_callbacks
from vdm_rt.frontend.callbacks.runtime import register_runtime_callbacks
from vdm_rt.frontend.callbacks.process import register_process_callbacks
from vdm_rt.frontend.callbacks.feed import register_feed_callbacks
from vdm_rt.frontend.callbacks.profile import register_profile_callbacks
from vdm_rt.frontend.callbacks.logs import register_logs_callbacks
from vdm_rt.frontend.callbacks.chat import register_chat_callbacks
from vdm_rt.frontend.callbacks.engram import register_engram_callbacks
from vdm_rt.frontend.callbacks.perf import register_perf_callbacks
from vdm_rt.frontend.callbacks.interval import register_interval_callbacks
from vdm_rt.frontend.callbacks.file_picker.registrars import (
...
def build_app(runs_root: str) -> Dash:
    ...
    data_dir = os.path.join(repo_root, "vdm_rt", "data")
