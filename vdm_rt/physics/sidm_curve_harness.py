...
from vdm_rt.core.cosmology import GrainScatteringShim
from vdm_rt.physics.harness_logging import enrich_payload, hash_jsonable
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Base output directory (defaults to vdm_rt/physics/outputs).",
    )
    parser.add_argument(
        "--figure",
        type=str,
