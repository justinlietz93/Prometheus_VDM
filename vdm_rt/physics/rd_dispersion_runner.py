...
RD dispersion validation runner (linear regime) for vdm_rt.
...
def main():
    parser = argparse.ArgumentParser(description="vdm_rt mirror: Validate RD linear dispersion σ(k) with identical metrics/schema.")
