...
propagates it through :class:`~vdm_rt.core.cosmology.VacuumAccumulator`, and
...
Usage example::
    ...
    python vdm_rt/physics/vacuum_demographics_harness.py \
...
from vdm_rt.core.cosmology import (  # noqa: E402
    BudgetTick,
    HorizonActivityEvent,
    RetardedKernelSH,
    VacuumAccumulator,
)
from vdm_rt.physics.harness_logging import (  # noqa: E402
    enrich_payload,
    hash_file,
    hash_jsonable,
)
