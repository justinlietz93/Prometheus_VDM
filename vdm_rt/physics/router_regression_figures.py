...
from vdm_rt.physics.harness_logging import enrich_payload, hash_jsonable  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--outdir", type=str, default=None, help="Base output directory (default: vdm_rt/physics/outputs)")
