...
RD front-speed validation runner (Fisher-KPP) for vdm_rt.
...
- This runner provides an independent, apples-to-apples check inside vdm_rt with identical metrics/output schema.
...
def main():
    parser = argparse.ArgumentParser(description="vdm_rt mirror: Validate Fisher-KPP front speed c=2√(Dr) with identical metrics/schema.")
    ...
    parser.add_argument("--outdir", type=str, default=None, help="base output dir; defaults to vdm_rt/physics/outputs next to this script")
